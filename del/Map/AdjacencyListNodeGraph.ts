...
import {
  AdjacencyListGraphNodeInterface,
  AdjacencyListGraphInterface,
} from "@/misc/interfaces";

type CB<D> = (data: D, ...args: any[]) => [boolean, any[]];

export class Node<D extends object = any>
  implements AdjacencyListGraphNodeInterface<D>
{
  data;
  ...
  implements AdjacencyListGraphInterface<Node<D>>
{
   ...
   * @param validator
   */
  searchDepthFirst(validator?: (data: Node<D>, ...args: any[]) => boolean): {
    height: number;
  } {
